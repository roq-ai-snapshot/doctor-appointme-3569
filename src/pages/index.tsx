  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience seamless healthcare with Doctor Appointment System v1. Streamline your bookings, manage schedules effortlessly, and prioritize your health today."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience seamless healthcare with Doctor Appointment System v1. Streamline your bookings, manage schedules effortlessly, and prioritize your health today.`}
            </Text>
            <Box
