...
import { useBillingCount, useInvoiceCount, useMedicalRecordCount, useRoqPlatformUserProfiles } from 'lib/roq';

import { InvoiceListPage as ShowCaseList } from 'pages/invoices';
          ...
          <Stack direction="column" spacing={8} flex={{ base: 1, md: 7 }}>
            ...
            <Box>
              <Flex mb={4} justifyContent={'space-between'}>
                ...
                <NextLink href={`invoices`} passHref legacyBehavior>
                  <Button
